...
rtBTransitions [ ] = { { ( char_T * ) ( & rtB . owzdk0illb [ 0 ] ) , 0 , 0 ,
39 } , { ( char_T * ) ( & rtDW . cxpfuvgpez [ 0 ] ) , 0 , 0 , 2 } , { (
char_T * ) ( & rtDW . nswo4x3pxj [ 0 ] ) , 11 , 0 , 25 } , { ( char_T * ) ( &
rtDW . cix3io0m5t [ 0 ] ) , 10 , 0 , 30 } } ; static DataTypeTransitionTable
rtBTransTable = { 4U , rtBTransitions } ; static DataTypeTransition
rtPTransitions [ ] = { { ( char_T * ) ( & rtP . DCVoltageSource_Amplitude ) ,
0 , 0 , 1090 } } ; static DataTypeTransitionTable rtPTransTable = { 1U ,
rtPTransitions } ;
